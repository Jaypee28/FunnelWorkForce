...
<head>
  ...
  <!-- Site Properities -->
  <title>Post a Job - Description</title>
...
<div><h2 class="ui header">Description</h2>Step 2 of 7</div>
<div class="ui section divider"></div>
<h5 class="ui header">Description</h5>
<h5 class="ui header" style="margin-top: 1px;">A good description includes:</h5>
<ul>
  <li>What the deliverable is</li>
  <li>Type of freelancer you're looking for</li>
  <li>Anything unique about the project or team</li>
</ul>
<div class="ui form" style="padding-bottom: 2%;">
  <div class="field">
    <textarea></textarea>
  </div>
</div>
...
<div class="file-upload" style="margin-top: -25px;">
  <div class="image-upload-wrap">
    ...
    <div class="drag-text">
      <h3 style="text-transform: lowercase;">Drag and drop a file</h3>
    </div>
  </div>
  ...
  <p style="color: grey; margin-top: 10px;">You may attach up to 5 files under <b>100 MB</b> each</p>
</div>
  <div class="ui section divider"></div>
