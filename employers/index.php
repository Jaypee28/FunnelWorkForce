...
<body id="home" style="background-color: #f4f9ff;">
  ...
  <div class="header">
    ...
    <div class="content">
<form class="ui form" style="width: 320px;">
...
<div class="submit_btn" style="float: right; padding: 20px 0px;">
 ...
 <form class="ui form" style="width: 300px;">
  ...
  <div class="item center aligned">
    <a id="eProfile"><i style="float: right;" class="pencil alternate icon"></i></a>
  ...
  <div class="sixteen wide column">
    <div class="ui fluid card">
  <div class="content">
   <h3>Company Name<a id="eProfileSummary"><i style="float: right;" class="pencil alternate icon"></i></a></h3>
  </div>
</div>
