...
<body id="home" style="background-color: #f4f9ff;">
  ...
  <!-- //Navbar -->
   ...
   <div class="sixteen wide column" style="margin-bottom: 20px;">
     <div class="ui four column center aligned stackable grid" style="margin-bottom: 20px;">
        <div class="column">
  ...
  <div class="content">
    <div class="header" style="margin-bottom: 20px;font-size: 20px;">Freelancer Name
        <span class="company_logo">
          <img class="zoom" src="../assets/img/img_avatar.png">
        </span>
    </div>
    <div class="header">Sample Job</div>
